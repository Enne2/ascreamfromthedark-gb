...
all: $(BUILD_DIR)/AScreamFromTheDark.gb $(BUILD_DIR)/test_gameover.gb $(BUILD_DIR)/test_finale.gb
...
# Alias: la ROM principale ha gia' il nome del gioco
release: all
...
# Main ROM target
$(BUILD_DIR)/AScreamFromTheDark.gb: $(SRCS)
	mkdir -p $(BUILD_DIR)
	$(LCC) $(LCCFLAGS) -o $(BUILD_DIR)/AScreamFromTheDark.gb $(SRCS)
...
test: $(BUILD_DIR)/AScreamFromTheDark.gb
	$(PYTHON) $(SCRIPTS_DIR)/validate_rom_header.py $< --title "$(ROM_TITLE)"
	$(PYTHON) $(SCRIPTS_DIR)/validate_tiling_visual.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/floor.png --scenario floor
	$(PYTHON) $(SCRIPTS_DIR)/validate_tiling_visual.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/hatch.png --scenario hatch
	$(PYTHON) $(SCRIPTS_DIR)/validate_tiling_visual.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/wrap_x.png --scenario wrap_x
	$(PYTHON) $(SCRIPTS_DIR)/validate_tiling_visual.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/wrap_y.png --scenario wrap_y
	$(PYTHON) $(SCRIPTS_DIR)/validate_tiling_visual.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/stamina_0.png --scenario floor --stamina 0
	$(PYTHON) $(SCRIPTS_DIR)/validate_tiling_visual.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/stamina_50.png --scenario floor --stamina 50
	$(PYTHON) $(SCRIPTS_DIR)/validate_tiling_visual.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/stamina_100.png --scenario floor --stamina 100
	$(PYTHON) $(SCRIPTS_DIR)/validate_static_screen.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/title.png --screen title
	$(PYTHON) $(SCRIPTS_DIR)/validate_static_screen.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/intro.png --screen intro
	$(PYTHON) $(SCRIPTS_DIR)/validate_static_screen.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/credits.png --screen credits
	$(PYTHON) $(SCRIPTS_DIR)/validate_static_screen.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/instructions.png --screen instructions
	$(PYTHON) $(SCRIPTS_DIR)/validate_static_screen.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/death.png --screen death
	$(PYTHON) $(SCRIPTS_DIR)/validate_static_screen.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/deeper.png --screen deeper
	$(PYTHON) $(SCRIPTS_DIR)/validate_static_screen.py $< $(BUILD_DIR)/AScreamFromTheDark.noi $(BUILD_DIR)/test-artifacts/finale.png --screen finale
